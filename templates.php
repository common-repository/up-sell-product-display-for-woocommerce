...
function cdxfreewooup_get_up_sell_products($product_id=false){
	...
	if ( sizeof($upsells ) == 0  || $upsells =='') { return false; }
...
*/
function cdxfreewooup_check_if_woocommerce_is_active(){
...
* Theme - List View
*/
function cdxfreewooup_theme_list_view($products=false){

	if(cdxfreewooup_check_if_woocommerce_is_active()===false){return 'Error! Woocommerce is not installed or not active.';}
	
	if($products === false ){
		$products = cdxfreewooup_get_up_sell_products();
	}
...
* Theme - Hover
*/
function cdxfreewooup_theme_hover($products=false){
